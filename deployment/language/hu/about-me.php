...
$l['content']
    ...
    <ul class="list-group profile-list">
        ...
        <li class="list-group-item">
            Megtalálsz a <strong><a target="_blank" href="https://github.com/patrikx3">GitHub</a></strong>-on és nézd meg a mikroszervízeimet a <strong><a target="_blank" href="https://pages.corifeus.com">Corifeus</a></strong>-on..
        </li>        
        <li class="list-group-item">
