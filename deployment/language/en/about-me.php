...
$l['content']
    ...
    <ul class="list-group profile-list">
        ...
        <li class="list-group-item">
            You can find me on <strong><a target="_blank" href="https://github.com/patrikx3">GitHub</a></strong> and check out my microservices on <strong><a target="_blank" href="https://pages.corifeus.com">Corifeus</a></strong>. Usually, enterprise systems using NodeJs and AngularJs Material and playing with AI materials ...
        </li>
        <li class="list-group-item">
