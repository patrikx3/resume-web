...
$l['content']
    ...
    <ul class="list-group profile-list">
        ...
        <li class="list-group-item">
            <span class="{$profile_class}">2016</span> - I am a veteran programmer. Currently, my roles are senior software systems architect, development operations engineer (DevOps) and hacker at Sygnus.
        </li>
        <li class="list-group-item">
